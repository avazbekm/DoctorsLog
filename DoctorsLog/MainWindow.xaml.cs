...
namespace DoctorsLog
{
    ...
    {
        private Grid _patientsView;
        private Grid _prescriptionsView;
        ...
        public MainWindow()
        {
            ...
            _patientsView = (Grid)MainContentControl.Content;
        ...
        private void ShowPatientsView()
        {
            ...
            MainContentControl.Content = _patientsView;
        }
        ...
        private void ShowPrescriptionsView()
        {
            ...
            if (_prescriptionsView == null)
            {
                _prescriptionsView = CreatePrescriptionsView();
            }
            // MainContentControl'ga retseptlar view'ini yuklaymiz
            MainContentControl.Content = _prescriptionsView;
        }
